package com.dineshlearnings.aws.dao;
...
public class EmployeeDAO {
	...
	public static Map<Integer, Employee> mapOfEmloyees = new LinkedHashMap<Integer, Employee>();
	...
	static {
		...
		mapOfEmloyees.put(10003, new Employee("Eric", 10005, 12445.6, 1005));
	}
